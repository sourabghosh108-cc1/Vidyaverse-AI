...
class GameStore {
  ...
  getOpenRouterApiKey() {
    return localStorage.getItem("vidyaverse_openrouter_key") || "";
  }

  setOpenRouterApiKey(key) {
    if (key) {
      localStorage.setItem("vidyaverse_openrouter_key", key);
    } else {
      localStorage.removeItem("vidyaverse_openrouter_key");
    }
    this.notify();
  }

  // Legacy alias kept for backward compat
  getAnthropicApiKey() { return this.getOpenRouterApiKey(); }
  setAnthropicApiKey(key) { return this.setOpenRouterApiKey(key); }
