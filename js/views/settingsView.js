      ...
      <div class="settings-layout-wrapper animate-fade-in">
        ...
        <div class="settings-grid">
          ...
          <div class="settings-left-col">
            ...
            <!-- OpenRouter AI Settings (Pre-configured) -->
            <div class="card settings-api-card" style="margin-top: 24px;">
              <div style="display: flex; align-items: center; justify-content: space-between;">
                <h3>🤖 AI Agent Engine (OpenRouter)</h3>
                <span class="badge badge-success" style="background: rgba(34,197,94,0.15); color: #22c55e; padding: 4px 10px; border-radius: 12px; font-weight: 600; font-size: 0.8rem;">
                  ✅ Pre-Configured & Active
                </span>
              </div>
              <p style="color: var(--text-secondary); font-size: 0.9rem; margin-top: 8px;">
                Vidyaverse AI is powered by built-in OpenRouter integration (GPT-4o, Claude 3.5, Gemini). No setup required — all features, AI Chat, Notes Generation, PDF Summaries, and AI Arcade Games are active.
              </p>
            </div>
  ...
  bindEvents(container) {
    ...
    if (saveKeyBtn && keyInput) {
      saveKeyBtn.addEventListener("click", () => {
        ...
        store.setOpenRouterApiKey(newKey);
        if (newKey) {
          ui.showToast("✅ OpenRouter API Key saved! AI Agent Copilot is now live.", "success");
        } else {
          ui.showToast("OpenRouter API Key cleared.", "warning");
        }
      });
    }
